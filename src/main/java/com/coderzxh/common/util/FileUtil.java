...
public class FileUtil {
    ...
    //springboot实现
    static {
        ResourceBundle bundleKey = ResourceBundle.getBundle("application");
        String active =bundleKey.getString("spring.profiles.active");
        ResourceBundle bundle = ResourceBundle.getBundle("config/application-" + active);
        fileUploadPath = bundle.getString("file-upload.dir");
    }
...
//    }
        ...
        return  fileUploadPath + File.separator + fileName;
    }
