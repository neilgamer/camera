...
import com.coderzxh.web.exception.ParamJsonException;
...
public class AllControllerAdvice {
    ...
    public ResponseModel<String> errorHandler(Exception ex) {
        ...
        return ResponseHelper.systemFailure(PublicResultConstant.FAILED);
    }
    ...
    public ResponseModel<String> handleUnauthorized(UnauthorizedException e) {
