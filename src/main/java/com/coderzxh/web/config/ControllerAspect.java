...
import com.coderzxh.common.util.StringUtil;
import com.coderzxh.web.annotation.AccessLimit;
import com.coderzxh.web.annotation.ParamXssPass;
import com.coderzxh.web.annotation.ValidationParam;
import com.coderzxh.web.aspect.AccessLimitAspect;
import com.coderzxh.web.aspect.AspectApiImpl;
import com.coderzxh.web.aspect.ParamXssPassAspect;
import com.coderzxh.web.aspect.ValidationParamAspect;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(* com.coderzxh.web.controller..*(..))  ")
    public void aspect() {
    }
